...
export function ConversationList({ activeId, onSelect }: ConversationListProps) {
  ...
  return (
    <div className="flex h-full min-h-0 w-80 flex-col border-r border-zinc-200/80 bg-white dark:border-zinc-800 dark:bg-zinc-950">
      {/* Search + Filter */}
      ...
      <div className="flex-1 overflow-y-auto scrollbar-thin">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center px-6 py-16 text-center">
            ...
            <p className="mt-3 text-[13px] font-medium text-red-500 dark:text-red-400">
              Erro ao carregar conversas
            </p>
            <p className="mt-1 px-4 text-[11px] text-zinc-500 dark:text-zinc-400">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-0.5 flex items-center gap-1.5">
                    ...
                    {(conv.unreadCount ?? 0) > 0 && (
                      <span className="ml-auto inline-flex h-5 min-w-5 shrink-0 items-center justify-center rounded-full bg-emerald-500 px-1.5 text-[10px] font-bold text-white">
