  ...
  return (
    <div className="relative isolate flex h-svh w-full overflow-hidden bg-white max-lg:flex-col lg:bg-zinc-100 dark:bg-zinc-900 dark:lg:bg-zinc-950">
      ...
      <main className="flex flex-1 flex-col lg:min-w-0 lg:pl-64">
        ...
        {/* Page content */}
        <div className="flex overflow-hidden flex-1 flex-col min-h-0 lg:bg-white lg:shadow-sm lg:ring-1 lg:ring-zinc-950/5 dark:lg:bg-zinc-900 dark:lg:ring-white/10">
          {children}
        </div>
      </main>
    </div>
