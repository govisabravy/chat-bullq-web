        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-zinc-100 bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-900/50">
              ...
              <th className="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider text-zinc-500">Telefone</th>
              <th className="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider text-zinc-500">Canais</th>
              <th className="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider text-zinc-500">Tags</th>
              <th className="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider text-zinc-500">Conversas</th>
            </tr>
          </thead>
          <tbody>
            {isLoading ? (
              ...
              <tr>
                <td colSpan={5} className="px-4 py-16 text-center">
                  ...
                  <p className="mt-3 text-sm font-medium text-red-500">Erro ao carregar contatos</p>
                    ...
                    <div className="flex items-center gap-3">
                      {contact.avatarUrl ? (
                        ...
                        <img
                          ...
                          alt={contact.name || ''}
                          className="h-8 w-8 shrink-0 rounded-full object-cover bg-zinc-100 dark:bg-zinc-800"
